...
export function BattlePreviewCard() {
  ...
  return (
    <Link
      ...
      className="menu-tile group flex h-full flex-col gap-5 bg-[radial-gradient(circle_at_top_right,_rgba(69,211,255,0.16),_transparent_28%),linear-gradient(160deg,_rgba(8,12,34,0.98),_rgba(19,30,61,0.94))] text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-300"
    >
      ...
      <div className="relative flex items-start justify-between gap-4">
        ...
        <div className="rounded-full border border-cyan-300/20 bg-cyan-300/10 px-3 py-1 text-[11px] font-bold uppercase tracking-[0.16em] text-cyan-100">
          {hasActiveBattle ? t('preview.statusLive') : t('preview.statusReady')}
        </div>
      </div>

      <div className="relative grid gap-4 rounded-[1.75rem] border border-white/8 bg-[linear-gradient(180deg,_rgba(255,255,255,0.06),_rgba(255,255,255,0.03))] p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.05)]">
      ...
      <div className="mt-auto flex items-center justify-between rounded-[1.45rem] border border-white/12 bg-white px-4 py-3 text-slate-950 shadow-[0_18px_32px_rgba(8,12,34,0.32)]">
        <div>
